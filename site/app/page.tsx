...
const issueRows = [
  ...
  ["P2", "AndroidWorld", "官方 0.1.0、ADB、Pixel 6/API 33 AVD、gRPC 与客体路由预检通过；真实 reset/action/state 冒烟通过（18 个 UI 元素）；无 KVM，限软件仿真诊断", "冒烟通过"],
];
  ...
  return (
    <main>
      ...
      <section className="metric-grid" aria-label="核心状态">
        ...
        <Metric label="AndroidWorld 运行时" value="API 33" note="真实 reset/action/state 已通过；无 KVM" />
      </section>
