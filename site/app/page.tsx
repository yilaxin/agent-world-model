...
const issueRows = [
  ...
  ["P2", "AndroidWorld", "本机 WHPX：预检/冒烟通过（19 个 UI 元素）；任务级首轮 reactive 11.1% vs phase3 33.3%（语义目标匹配修正：open_chrome 0%→100%）", "首轮评测完成"],
];
  ...
  return (
    <main>
      ...
      <section className="metric-grid" aria-label="核心状态">
        ...
        <Metric label="AndroidWorld 运行时" value="API 33" note="WHPX 冒烟通过；任务级首轮评测完成" />
      </section>
