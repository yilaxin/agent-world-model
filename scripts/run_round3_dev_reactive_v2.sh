...
log="logs/round3_dev_reactive_v2_run.log"
: > "$log"
...
for site in reddit gitlab shopping; do
  ...
  ROUND2_REPORT="data/reports/webarena_p0_round3_dev_v2_${site}_reactive.json" \
  ROUND2_OUTPUT_DIR="data/trajectories_webarena_round3_dev_v2/${site}/reactive" \
